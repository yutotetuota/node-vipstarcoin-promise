...
var bitcoin = require( "node-vipstarcoin" ) ;
...
(function() {
	var methods = Object.getOwnPropertyNames(bitcoin.Client.prototype).filter(function(p) {
	    return typeof vipstarcoin.Client.prototype[p] === 'function' && p !== "cmd" && p!= "constructor";
	})
	  for (var i = 0 ; i<methods.length ; i++ ) {
		  var protoFn = methods[i] ;
	    (function(protoFn) {
	    	vipstarcoin.Client.prototype[protoFn] = function() {
	        var args = [].slice.call(arguments);
...
module.exports.Client = vipstarcoin.Client;
